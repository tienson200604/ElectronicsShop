        ...
        <%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <div class="container-fluid page-header py-5">
                ...
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="${contextPath}/shop">Cửa hàng</a></li>
                ...
                <div class="row g-4">
                    <div class="col-md-5">
                        <div class="border rounded p-3 text-center">
                            <img src="${contextPath}/${product.imagePath}" alt="${product.name}"
                                class="img-fluid rounded" style="max-height:420px;object-fit:contain;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <form action="${contextPath}/cart" method="get" class="d-flex align-items-center mb-3">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill py-2 px-4 ms-3">
                        ...
                        <p class="mb-1"><strong>Mã sản phẩm:</strong> ${product.id}</p>
                        <p class="mb-1"><strong>Mô tả:</strong> ${product.description}</p>
                        <p class="mb-1"><strong>Bảo hành:</strong> ${product.warrantyMonths} tháng</p>
                        <p class="mb-1"><strong>Kho:</strong> ${product.stockQuantity}</p>
                        <p class="mb-1">
