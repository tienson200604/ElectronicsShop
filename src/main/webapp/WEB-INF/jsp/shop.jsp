                        ...
                        <%-- Offer End --%>
                            ...
                            <%-- Filter & Search Start --%>
                                <div class="container-fluid bg-light py-3">
                                    <div class="container">
                                        <form class="row g-3 align-items-center" action="${contextPath}/shop"
                                            method="get">

                                            <div class="col-lg-4 col-md-6">
                                                <label class="form-label mb-1 fw-semibold">Giá tối đa</label>
                                                <input type="range" class="form-range" min="0" max="20000000"
                                                    step="200000" name="maxPrice"
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <small>0</small>
                                                    <small><span id="priceValue">${empty param.maxPrice ? 20000000 :
                                                            param.maxPrice}</span> ₫</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-5 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        placeholder="Nhập từ khóa sản phẩm" name="keyword"
                                                        value="${param.keyword}">
                                                            ...
                                                            <ul class="category-list">
                                                                <c:forEach var="cat" items="${categoryList}">
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <span
                                                                            class="category-badge">(${cat.productCount})</span>
                                                                    </li>
                                                                </c:forEach>
                                                            </ul>
                                                        </div>
                                                                ...
                                                                <div id="tab-5" class="tab-pane fade show p-0 active">
                                                                    <div class="row g-4 product">
                                                                        ...
                                                                        <c:choose>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a
                                                                                                            href="${contextPath}/product-detail?id=${product.id}">
                                                                                                            <i
                                                                            ...
                                                                            <c:otherwise>
                                                                                <div class="col-12">
                                                                                    <p class="alert alert-info">Không
                                                                                        tìm thấy sản phẩm nào.</p>
                                                                                </div>
                                                                            </c:otherwise>
                                                                        </c:choose>
                                                                                    ...
                                                                                    <nav aria-label="Page navigation">
                                                                                        <ul class="pagination mb-0">
                                                                                            ...
                                                                                            <c:url var="prevUrl"
                                                                                                ...
                                                                                                <c:if
                                                                                                    test="${not empty param.maxPrice}">
                                                                                                    <c:param
                                                                                                        name="maxPrice"
                                                                                                        value="${param.maxPrice}" />
                                                                                                </c:if>
                                                                                                <c:if
                                                                                                    test="${not empty param.sort}">
                                                                                                    <c:param name="sort"
                                                                                                        value="${param.sort}" />
                                                                                                </c:if>
                                                                                                <c:if
                                                                                                    test="${not empty param.categoryId}">
                                                                                                    <c:param
                                                                                                        name="categoryId"
