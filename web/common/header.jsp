...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>${pageTitle != null ? pageTitle : "Electro - Electronics Shop"}</title>
            ...
            <div class="row gx-0 align-items-center">
                <div class="col-lg-4 text-center text-lg-start mb-lg-0">
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        ...
                        <a href="${pageContext.request.contextPath}/contact" class="text-muted mx-2"> Support</a><small> / </small>
                        <a href="${pageContext.request.contextPath}/contact" class="text-muted ms-2"> Contact</a>
                    </div>
                </div>
            ...
            <div class="row gx-0 align-items-center text-center">
                ...
                <div class="col-md-4 col-lg-3 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a href="${pageContext.request.contextPath}/cart" class="text-muted d-flex align-items-center justify-content-center"><span class="rounded-circle btn-md-square border"><i class="fas fa-shopping-cart"></i></span> <span class="text-dark ms-2">$0.00</span></a>
                    </div>
                </div>
            </div>
        </div>
