            ...
            <div class="row g-0 justify-content-end">
                    ...
                    <div class="header-carousel owl-carousel bg-light py-5">
                        <div class="row g-0 header-carousel-item align-items-center">
                            ...
                            <div class="col-xl-6 carousel-content p-4">
                                ...
                                <a class="btn btn-primary rounded-pill py-3 px-5 wow fadeInRight" data-wow-delay="0.7s" href="${contextPath}/shop">Shop Now</a>
                            </div>
                        </div>
                        <div class="row g-0 header-carousel-item align-items-center">
                            <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                ...
                <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
                    <div class="carousel-header-banner h-100">
                        <img src="${contextPath}/img/header-img.jpg" class="img-fluid w-100 h-100" style="object-fit: cover;" alt="Image">
                        ...
                        <div class="carousel-banner">
                            <div class="carousel-banner-content text-center p-4">
                                <a href="${contextPath}/shop" class="d-block mb-2">SmartPhone</a>
                                <a href="${contextPath}/product-detail?id=1" class="d-block text-white fs-3">Apple iPad Mini <br> G2356</a>
                                <del class="me-2 text-white fs-5">$1,250.00</del>
                                <span class="text-primary fs-5">$1,050.00</span>
                            </div>
                            <a href="${contextPath}/cart?action=add&pid=1" class="btn btn-primary rounded-pill py-2 px-4"><i class="fas fa-shopping-cart me-2"></i> Add To Cart</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Offer End -->
        ...
        <%-- --------------------------------- SERVICES START (Tĩnh) --------------------------------- --%>
        <%-- ... (Giữ nguyên phần Services) ... --%>
        <%-- --------------------------------- SERVICES END --------------------------------- --%>

        <%-- --------------------------------- PRODUCTS OFFER START (Tĩnh) --------------------------------- --%>
        <%-- ... (Giữ nguyên phần Offers) ... --%>
        <%-- --------------------------------- PRODUCTS OFFER END --------------------------------- --%>


        <%-- --------------------------------- OUR PRODUCTS START (Dynamic) --------------------------------- --%>
            ...
            <div class="container py-5">
                <div class="tab-class">
                        ...
                        <div class="col-lg-8 text-end wow fadeInRight" data-wow-delay="0.1s">
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                <li class="nav-item mb-4">
                                    <%-- ĐÃ SỬA: Đổi tên thành Best Seller và active tab 1--%>
                                    <a class="d-flex mx-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-1">
                                        <span clas<s="text-dark" style="width: 130px;">Best Seller</span>
                                    </a>
                                </li>
                                <li class="nav-item mb-4">
                    ...
                    <div class="tab-content">
                        ...
                        <%-- TAB 1: BEST SELLER (CÓ PHÂN TRANG) --%>
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                                <c:if test="${empty bestSellerProductsPaged}">
                                     <div class="col-12"><p class="alert alert-info text-center">Không có sản phẩm bán chạy nào được tìm thấy.</p></div>
                                </c:if>
                                    ...
                                    <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                        <div class="product-item-inner border rounded">
                                            <div class="product-item-inner-item">
                                                <img src="${contextPath}/${p.imagePath}" class="img-fluid w-100 rounded-top" alt="${p.name}">
                                                ...
                                                <div class="product-details">
                                                    <a href="${contextPath}/product-detail?id=${p.id}"><i class="fa fa-eye fa-1x"></i></a>
                                                </div>
                                            </div>
                                            <div class="text-center rounded-bottom p-4">
                                                <a href="${contextPath}/shop?categoryId=${p.categoryId}" class="d-block mb-2">${p.categoryName}</a>
                                        ...
                                        <div class="product-item-add border border-top-0 rounded-bottom text-center p-4 pt-0">
                                            <a href="${contextPath}/cart?action=add&pid=${p.id}" class="btn btn-primary border-secondary rounded-pill py-2 px-4 mb-4"><i class="fas fa-shopping-cart me-2"></i> Add To Cart</a>
                            ...
                            <%-- PHẦN PHÂN TRANG CHO BEST SELLER --%>
                        ...
                        <%-- TAB 2: NEW ARRIVALS (GIỮ NỘI DUNG ĐỘNG) --%>
                        ...
                        <%-- TAB 3: FEATURED (Giữ nội dung động) --%>
                    ...
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <a href="${contextPath}/shop">
                            <div class="bg-primary rounded position-relative">
                                <img src="${contextPath}/img/product-banner.jpg" class="img-fluid w-100 rounded" alt="">
                                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4" style="background: rgba(255, 255, 255, 0.5);">
                                    ...
                                    <a href="${contextPath}/shop" class="btn btn-primary rounded-pill align-self-start py-2 px-4">Shop Now</a>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                        <a href="${contextPath}/shop">
                            <div class="text-center bg-primary rounded position-relative">
                                <img src="${contextPath}/img/product-banner-2.jpg" class="img-fluid w-100" alt="">
                                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4" style="background: rgba(242, 139, 0, 0.5);">
                                    ...
                                    <a href="${contextPath}/shop" class="btn btn-secondary rounded-pill align-self-center py-2 px-4">Shop Now</a>
                                </div>
                            </div>
                        </a>
                    </div>
