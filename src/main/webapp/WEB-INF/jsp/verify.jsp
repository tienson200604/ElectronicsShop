<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Xác thực tài khoản - Electro</title>
                ...
                <div class="auth-card">
                    ...
                    <div class="auth-body">
                        ...
                        <div class="alert alert-info text-center">
                            Mã xác thực đã được gửi đến email: <strong>${sessionScope.verifyingEmail}</strong>
                        </div>
                        ...
                        <form action="${contextPath}/verify" method="post">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-verify text-white py-2">
