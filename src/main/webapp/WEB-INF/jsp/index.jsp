                                        ...
                                        <div class="header-carousel owl-carousel bg-light py-5">
                                            <div class="row g-0 header-carousel-item align-items-center">
                                                <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                                                    <img src="${contextPath}/img/carousel-1.png" class="img-fluid w-100"
                                                        alt="Image">
                                                </div>
                                            ...
                                            <div class="row g-0 header-carousel-item align-items-center">
                                                <div class="col-xl-6 carousel-img wow fadeInLeft" data-wow-delay="0.1s">
                                                    <img src="${contextPath}/img/carousel-2.png" class="img-fluid w-100"
                                                        alt="Image">
                                                </div>
                                                <div class="col-xl-6 carousel-content p-4">
                                                    <h4 class="text-uppercase fw-bold mb-4 wow fadeInRight"
                                    ...
                                    <%-- Banner bên phải --%>
                                        <div class="col-12 col-lg-5 col-xl-3 wow fadeInRight" data-wow-delay="0.1s">
                                            <div class="carousel-header-banner h-100">
                                                <img src="${contextPath}/img/header-img.jpg"
                                                ...
                                                <div class="carousel-banner">
                                                    <div class="carousel-banner-content text-center p-4">
                                                        <a href="${contextPath}/shop" class="d-block mb-2">Điện
                                                            thoại</a>
                                        ...
                                        <div class="row px-xl-5">
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">ĐỔI TRẢ
                                                            MIỄN PHÍ</h6>
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">MIỄN PHÍ
                                                            GIAO HÀNG</h6>
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">HỖ TRỢ 24/7
                                                        </h6>
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">VOUCHER QUÀ
                                                            TẶNG</h6>
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">THANH TOÁN
                                                            AN TOÀN</h6>
                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-6 pb-4">
                                                <div class="d-flex align-items-center service-box mb-4 px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <h6 class="font-weight-semi-bold mb-1 service-title">MUA SẮM
                                                            ONLINE</h6>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <div class="position-relative overflow-hidden bg-light"
                                                            ...
                                                            <img class="img-fluid position-absolute w-100 h-100"
                                                                src="${contextPath}/img/offer-1.jpg"
                                                                style="object-fit: cover;" alt="">
                                                            <div
                                                                class="position-absolute d-flex flex-column align-items-start justify-content-center h-100 p-4">
                                                                <h5 class="text-uppercase">Chọn chiếc máy ảnh phù hợp
                                                                    nhất!</h5>
                                                                <h2 class="font-weight-bold">Smart Camera</h2>
                                                                <h3 class="font-weight-bold text-orange">Giảm 40%</h3>
                                                                <a href="${contextPath}/shop"
                                                                    class="btn btn-outline-dark mt-2">Mua ngay</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <div class="position-relative overflow-hidden bg-light"
                                                            style="height: 260px;">
                                                            <img class="img-fluid position-absolute w-100 h-100"
                                                                src="${contextPath}/img/offer-2.jpg"
                                                                style="object-fit: cover;" alt="">
                                                            <div
                                                                class="position-absolute d-flex flex-column align-items-start justify-content-center h-100 p-4">
                                                                <h5 class="text-uppercase">Tìm chiếc đồng hồ dành cho
                                                                    bạn!</h5>
                                                ...
                                                <%-- OUR PRODUCTS START --%>
                                                    <div class="container-fluid product py-5">
                                                        <div class="container py-5">
                                                            <div class="tab-class">
                                                                <div class="row g-4">
                                                                    <div class="col-lg-4 text-start wow fadeInLeft"
                                                                        data-wow-delay="0.1s">
                                                                        <h1>Sản phẩm</h1>
                                                                    </div>
                                                                    <div class="col-lg-8 text-end wow fadeInRight"
                                                                        data-wow-delay="0.1s">
                                                                        <ul
                                                                ...
                                                                <div class="tab-content">
                                                                    <%-- TAB 1: BEST SELLER --%>
                                                                        <div id="tab-1"
                                                                            ...
                                                                            <div class="row g-4">
                                                                                <c:if
                                                                                    test="${empty bestSellerProductsPaged}">
                                                                                    <div class="col-12">
                                                                                        <p
                                                                                ...
                                                                                <c:forEach var="p"
                                                                                    items="${bestSellerProductsPaged}">
                                                                                    <div
                                                                                        class="col-md-6 col-lg-4 col-xl-3">
                                                                                        <div class="product-item rounded wow fadeInUp"
                                                                                            data-wow-delay="0.1s">
                                                                                            <div
                                                                                                class="product-item-inner border rounded">
                                                                                                <div
                                                                                                    class="product-item-inner-item">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <a
                                                                                                            href="${contextPath}/product-detail?id=${p.id}">
                                                                                                            <i
                                                                                                                class="fa fa-eye fa-1x"></i>
                                                                                                        </a>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    class="text-center rounded-bottom p-4">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="d-flex">
                                                                                                        <a href="#"
                                                                                                            ...
                                                                                                            <span
                                                                                                                class="rounded-circle btn-sm-square border">
                                                                                                                <i
                                                                            ...
                                                                            <%-- Phân trang Best Seller --%>
                                                                                <c:if test="${totalPages > 1}">
                                                                                    <div
                                                                                        class="d-flex justify-content-center mt-4 shop">
                                                                                        <nav
                                                                ...
                                                                <div class="container">
                                                                    <div class="row g-4">
                                                                        <div class="col-lg-6 wow fadeInLeft"
                                                                            ...
                                                                            <a href="${contextPath}/shop">
                                                                                <div
                                                                                    class="bg-primary rounded position-relative">
                                                                                    ...
                                                                                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                                                                        ...
                                                                                        <h3
                                                                                            ...
                                                                                            EOS Rebel <br> <span>T7i
                                                                                                Kit</span></h3>
                                                                                        <p class="fs-4 text-muted">Từ
                                                                                            8.999.000₫</p>
                                                                                        <a href="${contextPath}/shop"
                                                                                            class="btn btn-primary rounded-pill align-self-start py-2 px-4">Mua
                                                                                            ngay</a>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        ...
                                                                        <div class="col-lg-6 wow fadeInRight"
                                                                            ...
                                                                            <a href="${contextPath}/shop">
                                                                                <div
                                                                                    class="text-center bg-primary rounded position-relative">
                                                                                    <img src="${contextPath}/img/product-banner-2.jpg"
                                                                                        class="img-fluid w-100" alt="">
                                                                                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center rounded p-4"
                                                                                        style="background: rgba(242, 139, 0, 0.5);">
                                                                                        <h2
                                                                                            class="display-2 text-secondary">
                                                                                            SALE</h2>
                                                                                        <h4
                                                                                            class="display-5 text-white mb-4">
                                                                                            Giảm giá tới 50%</h4>
                                                                                        <a href="${contextPath}/shop"
                                                                                            class="btn btn-secondary rounded-pill align-self-center py-2 px-4">Mua
                                                                                            ngay</a>
                                                                                    </div>
                                                                                </div>
                                                                            </a>
